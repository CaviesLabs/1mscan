...
//   const sourcesError =
//     "sources" in formState.errors
//       ? formState.errors.sources?.message
//       : undefined;
...
//     const newOptions = parsedMethods.map((option, index) => ({
//       label: option,
...
//       field,
//     }: {
//       field: ControllerRenderProps<FormFields, "contract_index">;
//     }) => {
//       const error =
//         "contract_index" in formState.errors
//           ? formState.errors.contract_index
//           : undefined;
