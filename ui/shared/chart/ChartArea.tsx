...
const ChartArea = ({
  ...
  const gradientStopColor = useToken(
    "colors",
    useColorModeValue("whiteAlpha.200", "blackAlpha.100"),
  )
  const defaultGradient = {
    startColor: useToken("colors", useColorModeValue("blue.100", "blue.400")),
    stopColor: useToken(
      "colors",
      transparentize(useColorModeValue("blue.100", "blue.400"), 0)(theme),
    ),
  }
  ...
  return (
    <>
      ...
      {color ? (
        ...
        <defs>
          <linearGradient
            id="gradient-chart-area-default"
            x1="0%"
            x2="0%"
            y1="0%"
            y2="100%"
