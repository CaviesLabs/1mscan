...
const ChartAxis = ({
  ...
  React.useEffect(() => {
    ...
    if (innerHeight !== undefined && type === "bottom") {
      axisGroup.call(axis).attr("transform", `translate(0, ${innerHeight})`)
    }

    if (innerWidth !== undefined && type === "left") {
      axisGroup.call(axis).attr("transform", `translate(${innerWidth}, -20)`)
    }
