...
import { convertFileEntryToFile, getAllFileEntries } from "./utils/files"
...
const DragAndDropArea = ({
  ...
  const borderColor = isDragOver ? "primary.light.3" : "link"
  ...
  return (
    <Center
      ...
      _hover={{
        borderColor: isDisabled ? disabledBorderColor : "primary.light.3",
      }}
      borderRadius="base"
      borderStyle="dashed"
      cursor="pointer"
