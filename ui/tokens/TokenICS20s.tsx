...
const placeholderData = {
  items: Array<TokenInfo<"ICS-20">>(10).fill(TOKEN_INFO_ICS_20),
  total_count: 10,
  next_page_params: null,
}

const TokenICS20s = ({ isActive }: Props) => {
...
export default memo(TokenICS20s, (prev, next) => {
